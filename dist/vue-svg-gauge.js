...
/* harmony import */ var _Gauge_vue_vue_type_template_id_3d158a12___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
var component = Object(_node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__["default"])(
  ...
  _Gauge_vue_vue_type_template_id_3d158a12___WEBPACK_IMPORTED_MODULE_0__["render"],
  _Gauge_vue_vue_type_template_id_3d158a12___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"],
  false,
  null,
  null,
  null
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Gauge_vue_vue_type_template_id_3d158a12___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(4);
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "render", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Gauge_vue_vue_type_template_id_3d158a12___WEBPACK_IMPORTED_MODULE_0__["render"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "staticRenderFns", function() { return _node_modules_vue_loader_lib_loaders_templateLoader_js_vue_loader_options_node_modules_vue_loader_lib_index_js_vue_loader_options_Gauge_vue_vue_type_template_id_3d158a12___WEBPACK_IMPORTED_MODULE_0__["staticRenderFns"]; });
...
exports.default = {
  ...
  computed: {
    ...
    viewBox: function viewBox() {
      var needleLength = this.needleLength,
          needleTailLength = this.needleTailLength,
          needleWidth = this.needleWidth,
          isCircle = this.isCircle,
          height = this.height;

      var tipOffset = needleLength > 0 ? needleLength : 0;

      var baseOffset = !isCircle ? Math.max(needleTailLength, Math.abs(needleWidth)) : 0;

      var dimensions = '0 0 ' + (RADIUS * 2 + tipOffset) + ' ' + (isCircle ? height + tipOffset : height + baseOffset);
      return dimensions;
    }
  },
  watch: {
  ...
  methods: {
    ...
    renderNeedle: function renderNeedle() {
      var a = this.getAngle(this.tweenedValue) - 90;
      var rad = Math.PI / 180;
      var w = this.needleWidth;
      var l = this.needleLength;
      var tl = this.needleTailLength;

      var nx1 = X_CENTER + w * Math.cos((a - 90) * rad);
      var ny1 = Y_CENTER + w * Math.sin((a - 90) * rad);

      var nx2 = X_CENTER + (RADIUS + l) * Math.cos(a * rad);
      var ny2 = Y_CENTER + (RADIUS + l) * Math.sin(a * rad);

      var nx3 = X_CENTER + w * Math.cos((a + 90) * rad);
      var ny3 = Y_CENTER + w * Math.sin((a + 90) * rad);

      var nx4 = X_CENTER + tl * Math.cos((a + 180) * rad);
      var ny4 = Y_CENTER + tl * Math.sin((a + 180) * rad);

      var points = nx1 + ',' + ny1 + ' ' + nx2 + ',' + ny2 + ' ';
